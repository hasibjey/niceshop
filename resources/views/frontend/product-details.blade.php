                        ...
                        <div class="product-gallery">
                            <div class="main-showcase">
                                <div class="image-zoom-container">
                                    <img src="{{ asset('img/product/product-details-6.webp') }}" alt="Product Main"
                                        class="img-fluid main-product-image drift-zoom" id="main-product-image"
                                        data-zoom="{{ asset('img/product/product-details-6.webp') }}">
                            ...
                            <div class="thumbnail-grid">
                                <div class="thumbnail-wrapper thumbnail-item active"
                                    data-image="{{ asset('img/product/product-details-6.webp') }}">
                                    <img src="{{ asset('img/product/product-details-6.webp') }}" alt="View 1"
                                        class="img-fluid">
                                </div>
                                <div class="thumbnail-wrapper thumbnail-item"
                                    data-image="{{ asset('img/product/product-details-7.webp') }}">
                                    <img src="{{ asset('img/product/product-details-7.webp') }}" alt="View 2"
                                        class="img-fluid">
                                </div>
                                <div class="thumbnail-wrapper thumbnail-item"
                                    data-image="{{ asset('img/product/product-details-8.webp') }}">
                                    <img src="{{ asset('img/product/product-details-8.webp') }}" alt="View 3"
                                        class="img-fluid">
                                </div>
                                <div class="thumbnail-wrapper thumbnail-item"
                                    data-image="{{ asset('img/product/product-details-4.webp') }}">
                                    <img src="{{ asset('img/product/product-details-4.webp') }}" alt="View 4"
                                        class="img-fluid">
                                </div>
                                <div class="thumbnail-wrapper thumbnail-item"
                                    data-image="{{ asset('img/product/product-details-5.webp') }}">
                                    <img src="{{ asset('img/product/product-details-5.webp') }}" alt="View 5"
                                        class="img-fluid">
                                </div>
                                <div class="thumbnail-wrapper thumbnail-item"
                                    data-image="{{ asset('img/product/product-details-3.webp') }}">
                                    <img src="{{ asset('img/product/product-details-3.webp') }}" alt="View 6"
                                        class="img-fluid">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="info-tabs-container">
                            <nav class="tabs-navigation nav">
                                ...
                                <button class="nav-link" data-bs-toggle="tab"
                                    ...
                                    type="button">Reviews (127)</button>
                            </nav>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="package-contents">
                                                    ...
                                                    <ul class="contents-list">
                                                        ...
                                                        <li><i class="bi bi-check-circle"></i>Premium Carrying Case
                                                        </li>
                                                        <li><i class="bi bi-check-circle"></i>USB-C Fast Charging Cable
                                                        </li>
                                                        <li><i class="bi bi-check-circle"></i>3.5mm Audio Connector
                                                        </li>
                                                        <li><i class="bi bi-check-circle"></i>Quick Start Guide</li>
                                                        <li><i class="bi bi-check-circle"></i>Warranty Documentation
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="customer-reviews-list">
                                            <div class="review-card">
                                                <div class="reviewer-profile">
                                                    <img src="{{ asset('img/person/person-f-3.webp') }}" alt="Customer"
                                                        class="profile-pic">
                                                ...
                                                <div class="review-actions">
                                                    <button class="action-btn"><i class="bi bi-hand-thumbs-up"></i>
                                                        Helpful (12)</button>
                                            ...
                                            <div class="review-card">
                                                <div class="reviewer-profile">
                                                    <img src="{{ asset('img/person/person-m-5.webp') }}" alt="Customer"
                                                        class="profile-pic">
                                                    <div class="profile-details">
                                                ...
                                                <div class="review-text">
                                                    <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit
                                                        aut fugit, sed quia consequuntur magni dolores eos qui ratione
                                                        voluptatem sequi nesciunt. Overall satisfied with the purchase.
                                                    </p>
                                                </div>
                                                <div class="review-actions">
                                                    <button class="action-btn"><i class="bi bi-hand-thumbs-up"></i>
                                            ...
                                            <div class="review-card">
                                                <div class="reviewer-profile">
                                                    <img src="{{ asset('img/person/person-f-7.webp') }}" alt="Customer"
                                                        class="profile-pic">
                                                    <div class="profile-details">
