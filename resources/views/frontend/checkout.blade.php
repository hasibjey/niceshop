                            ...
                            <form class="checkout-form">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" name="first-name" class="form-control"
                                                    id="first-name" placeholder="Your First Name" required="">
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="last-name">Last Name</label>
                                                <input type="text" name="last-name" class="form-control"
                                                    id="last-name" placeholder="Your Last Name" required="">
                                            </div>
                                        </div>
                                ...
                                <div class="checkout-section" id="payment-method">
                                    ...
                                    <div class="section-content">
                                        ...
                                        <div class="payment-details d-none" id="paypal-details">
                                            <p class="payment-info">You will be redirected to PayPal to complete your
                                                purchase securely.</p>
                                        </div>

                                        <div class="payment-details d-none" id="apple-pay-details">
                                            <p class="payment-info">You will be prompted to authorize payment with
                                                Apple Pay.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="checkout-section" id="order-review">
                                    ...
                                    <div class="section-content">
                                        ...
                                        <div class="success-message d-none">Your order has been placed successfully!
                                ...
                                <div class="order-items">
                                    <div class="order-item">
                                        <div class="order-item-image">
                                            <img src="{{ asset('img/product/product-1.webp') }}" alt="Product"
                                                class="img-fluid">
                                        </div>
                                    ...
                                    <div class="order-item">
                                        <div class="order-item-image">
                                            <img src="{{ asset('img/product/product-2.webp') }}" alt="Product"
                                                class="img-fluid">
                                        </div>
                                        <div class="order-item-details">
                    ...
                    <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p>Suspendisse in orci enim. Vivamus hendrerit arcu sed erat molestie vehicula. Sed
                    ...
                    <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam in dui mauris.
                                    Vivamus hendrerit arcu sed erat molestie vehicula. Sed auctor neque eu tellus
                                    rhoncus ut eleifend nibh porttitor. Ut in nulla enim.</p>
                                <p>Suspendisse in orci enim. Vivamus hendrerit arcu sed erat molestie vehicula. Sed
                                    auctor neque eu tellus rhoncus ut eleifend nibh porttitor. Ut in nulla enim.
                                    Phasellus molestie magna non est bibendum non venenatis nisl tempor.</p>
                                <p>Suspendisse in orci enim. Vivamus hendrerit arcu sed erat molestie vehicula. Sed
