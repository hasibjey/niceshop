            ...
            <div class="col-lg-6">
                <div class="category-featured" data-aos="fade-right" data-aos-delay="200">
                    <div class="category-image">
                        <img src="{{ asset('img/product/product-f-2.webp') }}" alt="Women's Collection" class="img-fluid">
                    </div>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-6">
                        <div class="category-card cat-men" data-aos="fade-up" data-aos-delay="300">
                            <div class="category-image">
                                <img src="{{ asset('img/product/product-m-5.webp') }}" alt="Men's Fashion" class="img-fluid">
                            </div>
                            <div class="category-content">
                                <h4>Men's Wear</h4>
                                <p>242 products</p>
                    ...
                    <div class="col-xl-6">
                        <div class="category-card cat-kids" data-aos="fade-up" data-aos-delay="400">
                            <div class="category-image">
                                <img src="{{ asset('img/product/product-8.webp') }}" alt="Kid's Fashion" class="img-fluid">
                            </div>
                            <div class="category-content">
                                <h4>Kid's Fashion</h4>
                                <p>185 products</p>
                    ...
                    <div class="col-xl-6">
                        <div class="category-card cat-cosmetics" data-aos="fade-up" data-aos-delay="500">
                            <div class="category-image">
                                <img src="{{ asset('img/product/product-3.webp') }}" alt="Cosmetics" class="img-fluid">
                            </div>
                            <div class="category-content">
                    ...
                    <div class="col-xl-6">
                        <div class="category-card cat-accessories" data-aos="fade-up" data-aos-delay="600">
                            <div class="category-image">
                                <img src="{{ asset('img/product/product-12.webp') }}" alt="Accessories" class="img-fluid">
                            </div>
                            <div class="category-content">
                                <h4>Accessories</h4>
                                <p>308 products</p>
